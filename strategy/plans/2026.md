...
The focus in 2026 is **content production and distribution**. The goal is to build a significant following — tens of thousands to hundreds of thousands of people — who are interested in a radically wiser world and a second renaissance. Raw audience size is not the aim; reaching the *right* people is.
