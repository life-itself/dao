...
For larger or more ambiguous projects — especially where the *why* is not obvious from the press release — add a short [[scqh|Situation / Complication / Question / Hypothesis]]. Not required for most projects. If the press release already makes the motivation clear, skip it.
